...
<div align="center">
  ...
  <!--   <img src="https://seeklogo.com/images/S/solana-sol-logo-12828AD23D-seeklogo.com.png" title="Solana" alt="Solana" width="50" height="50"/>&nbsp; -->
...
<!--   <img src="https://cryptologos.cc/logos/cosmos-atom-logo.svg?v=022"  title="Cosmos" alt="Cosmos" height="50"/>&nbsp; -->
</div><br><br>

<!-- ## (Incoming) Featured AI / Agent Projects
Coming soon – I’m curating a short list (no fluff, just signal):
1. RAG Playground – retrieval strategy A/B harness with scoring & latency breakdown.
2. Agent Lab – planner/executor sandbox + tool registry + trace viewer.
3. Prompt Telemetry Kit – lightweight prompt + cost + error instrumentation.

(Flag a repo you’d like highlighted and I’ll wire it in.) -->
